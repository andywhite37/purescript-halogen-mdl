...
(function(exports) {
  ...
  var urlSegment = function (v) {
      ...
      throw new Error("Failed pattern match at Route line 15, column 1 - line 15, column 30: " + [ v.constructor.name ]);
  };
  var showRoute = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Route line 31, column 1 - line 31, column 33: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var cpDemoTabs = Halogen_Component_ChildPath.cp8;
  ...
  var demoContainer = (function () {
      var renderPageContent = function (state) {
          ...
          throw new Error("Failed pattern match at DemoContainer line 247, column 29 - line 303, column 37: " + [ state.currentRoute.constructor.name ]);
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof UpdateRoute) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $79 = {};
                  for (var $80 in state) {
                      if ({}.hasOwnProperty.call(state, $80)) {
                          $79[$80] = state[$80];
                      };
                  };
                  $79.currentRoute = v.value0;
                  return $79;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v instanceof OnNavClick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-layout-drawer"))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at DemoContainer line 347, column 7 - line 349, column 29: " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          ...
          throw new Error("Failed pattern match at DemoContainer line 333, column 10 - line 366, column 12: " + [ v.constructor.name ]);
      };
      var renderLayoutDrawer = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutDrawer ]), Halogen_HTML_Properties.ref("mdl-layout-drawer") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutTitle ]) ])([ Halogen_HTML_Core.text("Halogen MDL") ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigation ]) ])([ renderLayoutDrawerLink(Route.Home.value), renderLayoutDrawerLink(Route.Badges.value), renderLayoutDrawerLink(Route.Buttons.value), renderLayoutDrawerLink(Route.Cards.value), renderLayoutDrawerLink(Route.Chips.value), renderLayoutDrawerLink(Route.Dialogs.value), renderLayoutDrawerLink(Route.Lists.value), renderLayoutDrawerLink(Route.Tabs.value) ]) ]);
      var render = function (state) {
...
(function(exports) {
  ...
  var matchRoute = (function () {
      ...
      return Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(badges)(buttons))(cards))(chips))(dialogs))(lists))(tabs))(home);
  })();
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Router line 102, column 12 - line 108, column 14: " + [ v.constructor.name ]);
      };
