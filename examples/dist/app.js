...
(function(exports) {
  ...
  var demoBadges = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at DemoBadges line 62, column 10 - line 67, column 12: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var demoHome = (function () {
      var renderDemoHomeHeader = Halogen_MDL_Cell.el.cell12Col_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Halogen MDL") ]) ]);
      var render = function (state) {
          return Halogen_MDL_Grid.el.grid_([ renderDemoHomeHeader ]);
      };
      var receiver = function (v) {
          return Data_Maybe.Nothing.value;
      };
...
(function(exports) {
  ...
  var demoContainer = (function () {
      var renderPageContent = function (state) {
          ...
          throw new Error("Failed pattern match at DemoContainer line 189, column 29 - line 210, column 40: " + [ state.currentRoute.constructor.name ]);
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof OnNavClick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-layout-drawer"))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at DemoContainer line 254, column 7 - line 256, column 29: " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          ...
          throw new Error("Failed pattern match at DemoContainer line 240, column 10 - line 263, column 12: " + [ v.constructor.name ]);
      };
      ...
      return Halogen_Component.lifecycleParentComponent(Data_Either.ordEither(ordDemoHomeSlot)(Data_Either.ordEither(ordDemoBadgesSlot)(Data_Either.ordEither(ordDemoButtonsSlot)(Data_Ord.ordVoid))))({
          initialState: initialState, 
          initializer: initializer, 
          finalizer: finalizer, 
          receiver: receiver, 
