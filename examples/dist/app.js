...
(function(exports) {
  ...
  var button = (function () {
      ...
      var getClasses = function (props) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ classes.button, classes.jsButton ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
              if (props.type instanceof Flat) {
                  return [  ];
              };
              if (props.type instanceof Raised) {
                  return [ classes.buttonRaised ];
              };
              if (props.type instanceof Fab) {
                  return [ classes.buttonFab ];
              };
              if (props.type instanceof MiniFab) {
                  return [ classes.buttonMiniFab ];
              };
              if (props.type instanceof Icon) {
                  return [ classes.buttonIcon ];
              };
              throw new Error("Failed pattern match at Halogen.MDL.Button line 139, column 10 - line 144, column 37: " + [ props.type.constructor.name ]);
              ...
              if (props.color instanceof Colored) {
                  return [ classes.buttonColored ];
              };
              if (props.color instanceof Primary) {
                  return [ classes.buttonPrimary ];
              };
              if (props.color instanceof Accent) {
                  return [ classes.buttonAccent ];
              };
              throw new Error("Failed pattern match at Halogen.MDL.Button line 145, column 10 - line 149, column 41: " + [ props.color.constructor.name ]);
          })())((function () {
              if (props.ripple) {
                  return [ Halogen_MDL_RippleEffect.classes.jsRippleEffect ];
              };
              return [  ];
          })())));
      };
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Halogen.MDL.Button line 155, column 10 - line 176, column 12: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var renderContent = function (state) {
          ...
          throw new Error("Failed pattern match at DemoContainer line 132, column 25 - line 142, column 40: " + [ state.currentRoute.constructor.name ]);
      };
      var receiver = function (v) {
          return Data_Maybe.Just.create(Halogen_Query.action(UpdateState.create(v.value0)));
      };
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.classes.layout, Halogen_MDL_Layout.classes.jsLayout, Halogen_MDL_Layout.classes.layoutFixedHeader ]), Halogen_HTML_Properties.ref("mdl-layout-ref") ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.classes.layoutHeader ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.classes.layoutHeaderRow ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.classes.layoutTitle ]) ])([ Halogen_HTML_Core.text("Halogen MDL") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.classes.layoutSpacer ]) ])([  ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.classes.navigation, Halogen_MDL_Layout.classes.layoutLargeScreenOnly ]) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.classes.navigationLink ]) ])([ Halogen_HTML_Core.text("Link") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.classes.navigationLink ]) ])([ Halogen_HTML_Core.text("Link") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.classes.navigationLink ]) ])([ Halogen_HTML_Core.text("Link") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.classes.navigationLink ]) ])([ Halogen_HTML_Core.text("Link") ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.classes.layoutDrawer ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.classes.layoutTitle ]) ])([ Halogen_HTML_Core.text("Title") ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.classes.navigation ]) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(Route.href(Route.Home.value)), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.classes.navigationLink ]) ])([ Halogen_HTML_Core.text(Route.label(Route.Home.value)) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(Route.href(Route.Badges.value)), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.classes.navigationLink ]) ])([ Halogen_HTML_Core.text(Route.label(Route.Badges.value)) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(Route.href(Route.Buttons.value)), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.classes.navigationLink ]) ])([ Halogen_HTML_Core.text(Route.label(Route.Buttons.value)) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.classes.layoutContent ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "page-content" ]) ])([ renderContent(state) ]) ]) ]);
      };
      var initializer = Data_Maybe.Just.create(Halogen_Query.action(InitializeComponent.create));
      var initialState = function (v) {
          return v.value0;
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at DemoContainer line 145, column 10 - line 158, column 12: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleParentComponent(ordSlot)({
          initialState: initialState, 
          initializer: initializer, 
