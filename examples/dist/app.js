...
(function(exports) {
  ...
  var path = function (v) {
      ...
      throw new Error("Failed pattern match at Route line 10, column 1 - line 10, column 24: " + [ v.constructor.name ]);
  };
...
(function(exports) {
     ...
     */  
      var $$eval = function (v) {
          if (v instanceof InitializeComponent) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-layout-ref"))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_MDL.upgradeElement(v1.value0));
                      };
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      throw new Error("Failed pattern match at Container line 154, column 7 - line 157, column 29: " + [ v1.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof OnButtonMessage) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_Event_Event.preventDefault(DOM_Classy_Event.toEvent(DOM_Classy_Event.isEventMouseEvent)(v.value0.value0))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $31.clickCount = state.clickCount + 1 | 0;
                      return $31;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
          ...
          throw new Error("Failed pattern match at Container line 151, column 10 - line 175, column 12: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleParentComponent(ordButtonSlot)({
  ...
  exports["init"] = init;
  exports["eqButtonSlot"] = eqButtonSlot;
  exports["ordButtonSlot"] = ordButtonSlot;
...
(function(exports) {
  ...
  var OnContainerMessage = (function () {
      function OnContainerMessage(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OnContainerMessage.create = function (value0) {
          return function (value1) {
              return new OnContainerMessage(value0, value1);
          };
      };
      return OnContainerMessage;
  })();
  var GoTo = (function () {
  ...
  var matchRoute = (function () {
      ...
      var buttons = Data_Functor.voidRight(Routing_Match.matchFunctor)(Route.Buttons.value)(route("buttons"));
      var badges = Data_Functor.voidRight(Routing_Match.matchFunctor)(Route.Badges.value)(route("badges"));
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("root") ])([ Halogen_HTML.slot(ContainerSlot.value)(Container.container)(Container.init({
              currentRoute: state.currentRoute, 
              clickCount: 0
          }))(Halogen_HTML_Events.input(OnContainerMessage.create)) ]);
      };
      var receiver = function (v) {
          return Data_Maybe.Nothing.value;
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof OnContainerMessage) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          };
