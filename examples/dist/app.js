      ...
      var $$eval = function (v) {
          if (v instanceof InitializeComponent) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-button"))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at Halogen.MDL.Button line 161, column 7 - line 164, column 29: " + [ v2.constructor.name ]);
                      })())(function () {
          ...
          throw new Error("Failed pattern match at Halogen.MDL.Button line 155, column 10 - line 180, column 12: " + [ v.constructor.name ]);
      };
    
      // Render the button
  var render = function (v) {
          return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.ref("mdl-button"), Halogen_HTML_Properties.classes(getClasses(v)), Halogen_HTML_Properties.disabled(v.disabled), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input(OnClick.create)) ])([ Halogen_HTML_Core.text(v.text) ]);
      };
...
(function(exports) {
  ...
  var showRoute = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Route line 10, column 1 - line 10, column 33: " + [ v.constructor.name ]);
  });
  exports["Home"] = Home;
...
(function(exports) {
  ...
  var container = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text(Data_Show.show(Route.showRoute)(state.currentRoute)) ]), Halogen_HTML.slot(ButtonSlot.value)(Halogen_MDL_Button.button)(Halogen_MDL_Button.init({
              type: Halogen_MDL_Button.Raised.value, 
              color: Halogen_MDL_Button.Colored.value, 
              text: "Click this", 
              disabled: false, 
              ripple: true
          }))(Halogen_HTML_Events.input(OnButtonMessage.create)), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Button has been clicked " + (Data_Show.show(Data_Show.showInt)(state.clickCount) + " times.")) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Badge.classes.badge ]), Halogen_HTML_Properties.attr("data-badge")(Data_Show.show(Data_Show.showInt)(state.clickCount)) ])([ Halogen_HTML_Core.text("My badge") ]) ]);
      };
      var receiver = function (v) {
          return Data_Maybe.Just.create(Halogen_Query.action(UpdateState.create(v.value0)));
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof OnButtonMessage) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_Event_Event.preventDefault(DOM_Classy_Event.toEvent(DOM_Classy_Event.isEventMouseEvent)(v.value0.value0))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $25.clickCount = state.clickCount + 1 | 0;
                      return $25;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
          ...
          throw new Error("Failed pattern match at Container line 80, column 10 - line 93, column 12: " + [ v.constructor.name ]);
      };
