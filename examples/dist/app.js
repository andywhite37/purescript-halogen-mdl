...
(function(exports) {
  ...
  var InitializeState = (function () {
      function InitializeState(value0) {
          this.value0 = value0;
      };
      InitializeState.create = function (value0) {
          return new InitializeState(value0);
      };
  ...
  var props = function (props1) {
      return InitializeState.create(props1);
  };
  ...
  var button = (function () {
      ...
      var getClasses = function (props1) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ classes.button, classes.jsButton ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
              if (props1.type instanceof Flat) {
                  return [  ];
              };
              if (props1.type instanceof Raised) {
                  return [ classes.buttonRaised ];
              };
              if (props1.type instanceof Fab) {
                  return [ classes.buttonFab ];
              };
              if (props1.type instanceof MiniFab) {
                  return [ classes.buttonMiniFab ];
              };
              if (props1.type instanceof Icon) {
                  return [ classes.buttonIcon ];
              };
              throw new Error("Failed pattern match at Halogen.MDL.Button line 135, column 10 - line 140, column 37: " + [ props1.type.constructor.name ]);
          })())(Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
              if (props1.color instanceof Plain) {
                  return [  ];
              };
              if (props1.color instanceof Colored) {
                  return [ classes.buttonColored ];
              };
              if (props1.color instanceof Primary) {
                  return [ classes.buttonPrimary ];
              };
              if (props1.color instanceof Accent) {
                  return [ classes.buttonAccent ];
              };
              throw new Error("Failed pattern match at Halogen.MDL.Button line 141, column 10 - line 145, column 41: " + [ props1.color.constructor.name ]);
          })())((function () {
              if (props1.ripple) {
      ...
      var $$eval = function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-button"))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at Halogen.MDL.Button line 157, column 7 - line 160, column 29: " + [ v2.constructor.name ]);
                      })())(function () {
          ...
          throw new Error("Failed pattern match at Halogen.MDL.Button line 151, column 10 - line 176, column 12: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var HandleButton = (function () {
      function HandleButton(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleButton.create = function (value0) {
          return function (value1) {
              return new HandleButton(value0, value1);
          };
      };
      return HandleButton;
  })();
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Container.container)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
