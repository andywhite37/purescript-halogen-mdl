...
(function(exports) {
  ...
  var el = {
      spinner_: function (ref1) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.ref(ref1), Halogen_HTML_Properties.classes([ cl.spinner, cl.jsSpinner, cl.isActive ]) ])([  ]);
      }
  };
  exports["cl"] = cl;
  exports["el"] = el;
...
(function(exports) {
  ...
  var ordChildSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at DemoButtons line 72, column 8 - line 72, column 46: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
      ...
      var $$eval = function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state1) {
                      ...
                      for (var $31 in state1) {
                          if ({}.hasOwnProperty.call(state1, $31)) {
                              $30[$31] = state1[$31];
                          };
                      };
                      $30.clickDemo = (function () {
                          var $27 = {};
                          for (var $28 in state1.clickDemo) {
                              if ({}.hasOwnProperty.call(state1.clickDemo, $28)) {
                                  $27[$28] = state1["clickDemo"][$28];
                              };
                          };
                          $27.clickCount = state1.clickDemo.clickCount + 1 | 0;
                          return $27;
                      })();
                      return $30;
                  }))(function () {
          ...
          if (v instanceof OnNonComponentButtonClick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state1) {
                      var $42 = {};
                      for (var $43 in state1) {
                          if ({}.hasOwnProperty.call(state1, $43)) {
                              $42[$43] = state1[$43];
                          };
                      };
                      $42.nonComponentDemo = (function () {
                          var $39 = {};
                          for (var $40 in state1.nonComponentDemo) {
                              if ({}.hasOwnProperty.call(state1.nonComponentDemo, $40)) {
                                  $39[$40] = state1["nonComponentDemo"][$40];
                              };
                          };
                          $39.isLoading = true;
                          return $39;
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_MDL.upgradeElementByRef(Control_Monad_Aff.monadEffAff)("non-component-spinner"))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.delay(2000.0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state1) {
                                  var $48 = {};
                                  for (var $49 in state1) {
                                      if ({}.hasOwnProperty.call(state1, $49)) {
                                          $48[$49] = state1[$49];
                                      };
                                  };
                                  $48.nonComponentDemo = (function () {
                                      var $45 = {};
                                      for (var $46 in state1.nonComponentDemo) {
                                          if ({}.hasOwnProperty.call(state1.nonComponentDemo, $46)) {
                                              $45[$46] = state1["nonComponentDemo"][$46];
                                          };
                                      };
                                      $45.isLoading = false;
                                      return $45;
          ...
          throw new Error("Failed pattern match at DemoButtons line 417, column 10 - line 445, column 12: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var urlSegment = function (v) {
      ...
      throw new Error("Failed pattern match at Route line 11, column 1 - line 11, column 30: " + [ v.constructor.name ]);
  };
  var showRoute = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Route line 23, column 1 - line 23, column 33: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var demoContainer = (function () {
      var renderPageContent = function (state) {
          ...
          throw new Error("Failed pattern match at DemoContainer line 203, column 29 - line 231, column 38: " + [ state.currentRoute.constructor.name ]);
      };
          ...
          if (v instanceof OnNavClick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-layout-drawer"))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at DemoContainer line 275, column 7 - line 277, column 29: " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
      ...
      return Halogen_Component.lifecycleParentComponent(Data_Either.ordEither(ordDemoHomeSlot)(Data_Either.ordEither(ordDemoBadgesSlot)(Data_Either.ordEither(ordDemoButtonsSlot)(Data_Either.ordEither(ordDemoCardsSlot)(Data_Ord.ordVoid)))))({
          initialState: initialState, 
          initializer: initializer, 
          finalizer: finalizer, 
          receiver: receiver, 
...
(function(exports) {
  ...
  var matchRoute = (function () {
      ...
      return Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(badges)(buttons))(cards))(home);
  })();
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Router line 94, column 12 - line 100, column 14: " + [ v.constructor.name ]);
      };
