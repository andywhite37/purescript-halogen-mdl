  ...
  var upgradeElementByRef = function (dictMonadEff) {
      return function (ref) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ref))(function (v) {
              ...
              throw new Error("Failed pattern match at Halogen.MDL line 19, column 3 - line 21, column 25: " + [ v.constructor.name ]);
          });
      };
  };
...
(function(exports) {// Nasty hack to hide the layout drawer
...
(function(exports) {
  ...
  exports["cl"] = cl;
  exports["hideLayoutDrawer"] = $foreign.hideLayoutDrawer;
})(PS["Halogen.MDL.Layout"] = PS["Halogen.MDL.Layout"] || {});
(function(exports) {
    "use strict";
  var Halogen_HTML = PS["Halogen.HTML"];
...
(function(exports) {
  ...
  var renderContent = function (state) {
          ...
          throw new Error("Failed pattern match at DemoContainer line 202, column 25 - line 212, column 40: " + [ state.currentRoute.constructor.name ]);
      };
      var receiver = function (v) {
          return Data_Maybe.Just.create(Halogen_Query.action(UpdateState.create(v.value0)));
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof OnNavClick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-layout-drawer"))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_MDL_Layout.hideLayoutDrawer);
                      };
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      throw new Error("Failed pattern match at DemoContainer line 229, column 7 - line 231, column 29: " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          ...
          throw new Error("Failed pattern match at DemoContainer line 215, column 10 - line 234, column 12: " + [ v.constructor.name ]);
      };
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layout, Halogen_MDL_Layout.cl.jsLayout, Halogen_MDL_Layout.cl.layoutFixedHeader ]), Halogen_HTML_Properties.ref("mdl-layout-ref") ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutHeader ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutHeaderRow ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutTitle ]) ])([ Halogen_HTML_Core.text("Halogen MDL") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutSpacer ]) ])([  ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigation, Halogen_MDL_Layout.cl.layoutLargeScreenOnly ]) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigationLink ]) ])([ Halogen_HTML_Core.text("Link") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigationLink ]) ])([ Halogen_HTML_Core.text("Link") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigationLink ]) ])([ Halogen_HTML_Core.text("Link") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigationLink ]) ])([ Halogen_HTML_Core.text("Link") ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutDrawer ]), Halogen_HTML_Properties.ref("mdl-layout-drawer") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutTitle ]) ])([ Halogen_HTML_Core.text("Halogen MDL") ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigation ]) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(Route.href(Route.Home.value)), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigationLink ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(OnNavClick.create)) ])([ Halogen_HTML_Core.text(Route.label(Route.Home.value)) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(Route.href(Route.Badges.value)), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigationLink ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(OnNavClick.create)) ])([ Halogen_HTML_Core.text(Route.label(Route.Badges.value)) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(Route.href(Route.Buttons.value)), Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigationLink ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(OnNavClick.create)) ])([ Halogen_HTML_Core.text(Route.label(Route.Buttons.value)) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutContent ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "page-content" ]) ])([ renderContent(state), Halogen_MDL_MegaFooter.bl.megaFooter({
              middleSection: {
                  dropDownSections: [ {
