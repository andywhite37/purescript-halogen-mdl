...
(function(exports) {
  ...
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];        
  var el = {
      _3dRotation: Halogen_HTML_Core.text("3d_rotation"), 
      accessibility: Halogen_HTML_Core.text("accessibility"), 
      accessibile: Halogen_HTML_Core.text("accessibile"), 
      accountBalance: Halogen_HTML_Core.text("accoun_balance"), 
      accountBalanceWallet: Halogen_HTML_Core.text("accoun_balance_wallet"), 
      accountBox: Halogen_HTML_Core.text("account_box"), 
      accountCircle: Halogen_HTML_Core.text("account_circle"), 
      addShoppingCart: Halogen_HTML_Core.text("add_shopping_cart"), 
      alarm: Halogen_HTML_Core.text("alarm")
  };
  var cl = {
...
(function(exports) {
  ...
  var demoContainer = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof OnNavClick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-layout-drawer"))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at DemoContainer line 257, column 7 - line 259, column 29: " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          ...
          throw new Error("Failed pattern match at DemoContainer line 243, column 10 - line 266, column 12: " + [ v.constructor.name ]);
      };
