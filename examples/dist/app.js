...
(function(exports) {
  ...
  var eqState = new Data_Eq.Eq(function (x) {
      return function (y) {
          return Data_Eq.eq(eqButtonColor)(x.color)(y.color) && x.disabled === y.disabled && x.ref === y.ref && x.ripple === y.ripple && x.text === y.text && Data_Eq.eq(eqButtonType)(x.type)(y.type);
      };
  });
  ...
  var render = function (v) {
          return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.ref(v.ref), Halogen_HTML_Properties.classes(getClasses(v)), Halogen_HTML_Properties.disabled(v.disabled), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input(OnClick.create)) ])([ Halogen_HTML_Core.text(v.text) ]);
      };
