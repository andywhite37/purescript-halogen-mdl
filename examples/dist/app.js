...
(function(exports) {
  ...
  var demoTabs = (function () {
      ...
      var renderExampleWithRipple = [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Tabs.cl.tabs, Halogen_MDL_Tabs.cl.jsTabs, Halogen_MDL_RippleEffect.cl.jsRippleEffect ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_MDL_Tabs.cl.tabsTabBar) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#about-panel"), Halogen_HTML_Properties.classes([ Halogen_MDL_Tabs.cl.tabsTab, Halogen_MDL_Tabs.cl.isActive ]) ])([ Halogen_HTML_Core.text("About the Beatles") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#members-panel"), Halogen_HTML_Properties.classes([ Halogen_MDL_Tabs.cl.tabsTab ]) ])([ Halogen_HTML_Core.text("Members") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#albums-panel"), Halogen_HTML_Properties.classes([ Halogen_MDL_Tabs.cl.tabsTab ]) ])([ Halogen_HTML_Core.text("Discography") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Tabs.cl.tabsPanel, Halogen_MDL_Tabs.cl.isActive ]), Halogen_HTML_Properties.id_("about-panel") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.b_([ Halogen_HTML_Core.text("The Beatles") ]), Halogen_HTML_Core.text(" were a four-piece musical group from Liverpool, England. ...") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Their songs were among the best-loved music of all time. ...") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Tabs.cl.tabsPanel ]), Halogen_HTML_Properties.id_("members-panel") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("The Beatles' members were:") ]), Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("John Lennon (1940-1980)") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Paul McCartney (1942-)") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("George Harrison (1943-2001)") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Ringo Starr (1940-)") ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Tabs.cl.tabsPanel ]), Halogen_HTML_Properties.id_("albums-panel") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("The Beatles' original UK LPs, in order of release:") ]), Halogen_HTML_Elements.ol_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Please, Please Me (1963)") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("With the Beatles (1963)") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("...") ]) ]) ]) ]) ];
      var renderDemoSection = function (body) {
      ...
      var render = function (state) {
          return Halogen_MDL_Grid.el.grid_([ renderTabsHeader, renderDemoHeader("Example with ripple effect"), renderDemoSection(renderExampleWithRipple) ]);
      };
      var receiver = function (v) {
          return Data_Maybe.Just.create(Halogen_Query.action(UpdateState.create(v.value0)));
      };
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at DemoTabs line 137, column 10 - line 145, column 12: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
          initialState: initialState, 
          initializer: initializer, 
...
(function(exports) {
  ...
  var urlSegment = function (v) {
      ...
      throw new Error("Failed pattern match at Route line 14, column 1 - line 14, column 30: " + [ v.constructor.name ]);
  };
  var showRoute = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Route line 29, column 1 - line 29, column 33: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var cpDemoTabs = Halogen_Component_ChildPath.cp7;
  ...
  var demoContainer = (function () {
      var renderPageContent = function (state) {
          ...
          if (state.currentRoute instanceof Route.Tabs) {
              return Halogen_HTML["slot'"](cpDemoTabs)(DemoTabsSlot.value)(DemoTabs.demoTabs)(DemoTabs.init(Data_Unit.unit))(Halogen_HTML_Events.input(OnDemoTabsMessage.create));
          };
          throw new Error("Failed pattern match at DemoContainer line 236, column 29 - line 285, column 37: " + [ state.currentRoute.constructor.name ]);
      };
          ...
          if (v instanceof OnNavClick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-layout-drawer"))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at DemoContainer line 329, column 7 - line 331, column 29: " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
...
(function(exports) {
  ...
  var matchRoute = (function () {
      ...
      return Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(badges)(buttons))(cards))(chips))(dialogs))(tabs))(home);
  })();
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Router line 100, column 12 - line 106, column 14: " + [ v.constructor.name ]);
      };
