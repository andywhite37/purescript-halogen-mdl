 ...
 */  
  ...
  var demoBadges = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Badges !!!") ]) ]);
      };
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at DemoBadges line 68, column 10 - line 73, column 12: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var cpDemoBadges = Halogen_Component_ChildPath.cp1;
  var demoContainer = (function () {
      var renderPageContent = function (state) {
          ...
          throw new Error("Failed pattern match at DemoContainer line 175, column 29 - line 192, column 40: " + [ state.currentRoute.constructor.name ]);
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof OnNavClick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-layout-drawer"))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at DemoContainer line 236, column 7 - line 238, column 29: " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          ...
          throw new Error("Failed pattern match at DemoContainer line 222, column 10 - line 243, column 12: " + [ v.constructor.name ]);
      };
      var renderLayoutDrawer = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutDrawer ]), Halogen_HTML_Properties.ref("mdl-layout-drawer") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutTitle ]) ])([ Halogen_HTML_Core.text("Halogen MDL") ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigation ]) ])([ renderLayoutDrawerLink(Route.Home.value), renderLayoutDrawerLink(Route.Badges.value), renderLayoutDrawerLink(Route.Buttons.value) ]) ]);
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layout, Halogen_MDL_Layout.cl.jsLayout, Halogen_MDL_Layout.cl.layoutFixedHeader ]), Halogen_HTML_Properties.ref("mdl-layout-ref") ])([ renderLayoutHeader, renderLayoutDrawer, renderLayoutContent(state) ]);
      };
      return Halogen_Component.lifecycleParentComponent(Data_Either.ordEither(ordDemoBadgesSlot)(Data_Either.ordEither(ordDemoButtonsSlot)(Data_Ord.ordVoid)))({
          initialState: initialState, 
          initializer: initializer, 
          finalizer: finalizer, 
          receiver: receiver, 
