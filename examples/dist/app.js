...
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var $foreign = PS["Halogen.MDL.Slider"];
  var CSS = PS["CSS"];
...
(function(exports) {
  ...
  var demoTabs = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof InitializeComponent) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_MDL.upgradeElementsByClassNames([ Halogen_MDL_Tabs.cl.jsTabs, Halogen_MDL_RippleEffect.cl.jsRippleEffect ])))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof FinalizeComponent) {
...
(function(exports) {
  ...
  var demoToggles = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof InitializeComponent) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_MDL.upgradeElementsByClassNames([ Halogen_MDL_Checkbox.cl.jsCheckbox, Halogen_MDL_Radio.cl.jsRadio ])))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof FinalizeComponent) {
...
(function(exports) {
  ...
  var matchMatchClass = new Routing_Match_Class.MatchClass(function () {
      ...
      if (route instanceof Data_List_Types.Cons && route.value0 instanceof Routing_Types.Path) {
          ...
          throw new Error("Failed pattern match at Routing.Match line 58, column 31 - line 60, column 40: " + [ v.constructor.name ]);
      };
      return Data_Validation_Semiring.invalid(Data_Semiring_Free.free(Routing_Match_Error.ExpectedInt.value));
  }, function (input) {
      return function (route) {
      ...
      return function (route) {
          if (route instanceof Data_List_Types.Cons && route.value0 instanceof Routing_Types.Query) {
              ...
              throw new Error("Failed pattern match at Routing.Match line 83, column 9 - line 87, column 69: " + [ v.constructor.name ]);
          };
...
(function(exports) {
  ...
  var match = matchWith(Global["decodeURIComponent"]);
  exports["match"] = match;
...
(function(exports) {
  ...
  var matchRouteFromHash = function (hash) {
      var v = Routing.match(matchRoute)(hash);
      if (v instanceof Data_Either.Left) {
      ...
      throw new Error("Failed pattern match at Router line 77, column 3 - line 79, column 25: " + [ v.constructor.name ]);
  };

  // A producer coroutine that emits messages whenever the window emits a
  // `hashchange` event.
  var hashChangeProducer = Control_Coroutine_Aff.produce(function (emit) {
      var emitter = function (e) {
          var v = Control_Monad_Except.runExcept(DOM_HTML_Event_Types.readHashChangeEvent(Data_Foreign.toForeign(e)));
          if (v instanceof Data_Either.Left) {
              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
          };
          if (v instanceof Data_Either.Right) {
              return emit(new Data_Either.Left(v.value0));
          };
          throw new Error("Failed pattern match at Router line 52, column 7 - line 54, column 37: " + [ v.constructor.name ]);
      };
      return Control_Monad_Eff_Class.liftEff(Control_Monad_Eff_Class.monadEffEff)(function __do() {
          var $29 = DOM_HTML.window();
          return DOM_Event_EventTarget.addEventListener(DOM_HTML_Event_EventTypes.hashchange)(DOM_Event_EventTarget.eventListener(emitter))(false)(DOM_HTML_Types.windowToEventTarget($29))();
      });
  });
  ...
  // producer.
  var hashChangeConsumer = function (query) {
      return Control_Coroutine.consumer(Control_Monad_Aff.monadAff)(function (event) {
          var hash = Data_String.drop(1)(Data_String.dropWhile(function (v) {
              return v !== "#";
          })(DOM_HTML_Event_HashChangeEvent.newURL(event)));
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(query(Halogen_Query.action(GoTo.create(matchRouteFromHash(hash)))))(function () {
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Router line 160, column 12 - line 166, column 14: " + [ v.constructor.name ]);
      };
  ...
  exports["hashChangeProducer"] = hashChangeProducer;
  exports["hashChangeConsumer"] = hashChangeConsumer;
  exports["matchRouteFromHash"] = matchRouteFromHash;
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Router.component)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(v1.query(Halogen_Query.action(Router.GoTo.create(Route.Home.value))))(function () {
              return Control_Coroutine.runProcess(Control_Monad_Aff.monadRecAff)(Control_Coroutine.connect(Control_Monad_Aff.monadRecAff)(Control_Monad_Aff.parallelAff)(Router.hashChangeProducer)(Router.hashChangeConsumer(v1.query)));
          });
      });
  }));
  exports["main"] = main;
