          ...
          return function (blue$prime) {
              return function (alpha) {
                  ...
                  var hue$prime = function (v) {
                      ...
                      throw new Error("Failed pattern match at Color line 136, column 5 - line 137, column 5: " + [ v.constructor.name ]);
                  };
...
(function(exports) {
  ...
  var upgradeElementsByClassNames = function (classNames) {
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(upgradeElementsByClassName)(classNames));
  };
...
(function(exports) {exports.registerDialog = function(dialogElement) {
    return function() {
...
(function(exports) {
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];        
  var showDialogByRef = function (dictMonadEff) {
      return function (ref) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ref))(function (v) {
              if (v instanceof Data_Maybe.Just) {
                  return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))($foreign.showDialog(v.value0));
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              throw new Error("Failed pattern match at Halogen.MDL.Dialog line 33, column 3 - line 35, column 25: " + [ v.constructor.name ]);
          });
      };
  };
  var registerDialogByRef = function (dictMonadEff) {
      return function (ref) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ref))(function (v) {
              if (v instanceof Data_Maybe.Just) {
                  return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))($foreign.registerDialog(v.value0));
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              throw new Error("Failed pattern match at Halogen.MDL.Dialog line 26, column 3 - line 28, column 25: " + [ v.constructor.name ]);
          });
      };
  };
  var closeByRef = function (dictMonadEff) {
      return function (ref) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ref))(function (v) {
              if (v instanceof Data_Maybe.Just) {
                  return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))($foreign.close(v.value0));
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              throw new Error("Failed pattern match at Halogen.MDL.Dialog line 40, column 3 - line 42, column 25: " + [ v.constructor.name ]);
          });
      };
  };
  var cl = {
...
(function(exports) {
  ...
  var demoDialogs = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof InitializeComponent) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_MDL_Dialog.registerDialogByRef(Control_Monad_Aff.monadEffAff)("dialog-demo-1"))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof FinalizeComponent) {
          ...
          if (v instanceof ShowDialogDemo1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_MDL_Dialog.showDialogByRef(Control_Monad_Aff.monadEffAff)("dialog-demo-1"))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof CloseDialogDemo1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_MDL_Dialog.closeByRef(Control_Monad_Aff.monadEffAff)("dialog-demo-1"))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
...
(function(exports) {
  ...
  var demoMenus = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof InitializeComponent) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_MDL.upgradeElementsByClassNames([ Halogen_MDL_Menu.cl.jsMenu, Halogen_MDL_Button.cl.jsButton ])))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof FinalizeComponent) {
          ...
          throw new Error("Failed pattern match at DemoMenus line 104, column 10 - line 112, column 12: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
          initialState: initialState, 
          initializer: initializer, 
...
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var $foreign = PS["Halogen.MDL.Progress"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Control_Monad_Eff_Class = PS["Control.Monad.Eff.Class"];
...
(function(exports) {
  ...
  var demoProgress = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof InitializeComponent) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_MDL.upgradeElementsByClassName(Halogen_MDL_Progress.cl.jsProgress)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof FinalizeComponent) {
...
(function(exports) {
  ...
  var demoTabs = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof InitializeComponent) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_MDL.upgradeElementsByClassName(Halogen_MDL_Tabs.cl.jsTabs)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof FinalizeComponent) {
...
(function(exports) {
  ...
  var urlSegment = function (v) {
      ...
      throw new Error("Failed pattern match at Route line 18, column 1 - line 18, column 30: " + [ v.constructor.name ]);
  };
  var showRoute = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Route line 37, column 1 - line 37, column 33: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var cpDemoTabs = Halogen_Component_ChildPath.compose(Halogen_Component_ChildPath.compose(Halogen_Component_ChildPath.compose(Halogen_Component_ChildPath.compose(Halogen_Component_ChildPath.compose(Halogen_Component_ChildPath.compose(Halogen_Component_ChildPath.compose(Halogen_Component_ChildPath.compose(Halogen_Component_ChildPath.compose(Halogen_Component_ChildPath.compose(Halogen_Component_ChildPath.cpR)(Halogen_Component_ChildPath.cpR))(Halogen_Component_ChildPath.cpR))(Halogen_Component_ChildPath.cpR))(Halogen_Component_ChildPath.cpR))(Halogen_Component_ChildPath.cpR))(Halogen_Component_ChildPath.cpR))(Halogen_Component_ChildPath.cpR))(Halogen_Component_ChildPath.cpR))(Halogen_Component_ChildPath.cpR))(Halogen_Component_ChildPath.cpL);
  var cpDemoSpinners = Halogen_Component_ChildPath.cp10;
  ...
  var demoContainer = (function () {
      ...
      var renderPageContent = function (state) {
          ...
          throw new Error("Failed pattern match at DemoContainer line 290, column 29 - line 367, column 37: " + [ state.currentRoute.constructor.name ]);
      };
      ...
      var renderLayoutContent = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutContent ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "page-content" ]) ])([ renderPageContent(state), renderSpacer, renderMegaFooter ]) ]);
      };
      var $$eval = function (v) {
          if (v instanceof InitializeComponent) {
          ...
          if (v instanceof OnNavClick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("mdl-layout-drawer"))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at DemoContainer line 417, column 7 - line 419, column 29: " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          ...
          throw new Error("Failed pattern match at DemoContainer line 403, column 10 - line 442, column 12: " + [ v.constructor.name ]);
      };
      var renderLayoutDrawer = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutDrawer ]), Halogen_HTML_Properties.ref("mdl-layout-drawer") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ Halogen_MDL_Layout.cl.layoutTitle ]) ])([ Halogen_HTML_Core.text("Halogen MDL") ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ Halogen_MDL_Navigation.cl.navigation ]) ])([ renderLayoutDrawerLink(Route.Home.value), renderLayoutDrawerLink(Route.Badges.value), renderLayoutDrawerLink(Route.Buttons.value), renderLayoutDrawerLink(Route.Cards.value), renderLayoutDrawerLink(Route.Chips.value), renderLayoutDrawerLink(Route.Dialogs.value), renderLayoutDrawerLink(Route.Lists.value), renderLayoutDrawerLink(Route.Menus.value), renderLayoutDrawerLink(Route.Progress.value), renderLayoutDrawerLink(Route.Spinners.value), renderLayoutDrawerLink(Route.Tabs.value) ]) ]);
      var render = function (state) {
...
(function(exports) {
  ...
  var matchRoute = (function () {
      ...
      return Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(badges)(buttons))(cards))(chips))(dialogs))(lists))(menus))(progress))(spinners))(tabs))(home);
  })();
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Router line 108, column 12 - line 114, column 14: " + [ v.constructor.name ]);
      };
